...
from .views import (
    ...
    WorldProgressChartAPIView # Se importa la nueva vista
)
...
urlpatterns = [
    ...
    # Rutas de Estadísticas y Gráficos
    ...
    path('world-progress-chart/', WorldProgressChartAPIView.as_view(), name='world_progress_chart'), # Se añade la nueva ruta
]