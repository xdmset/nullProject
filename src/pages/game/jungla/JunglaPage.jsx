...
export default function CityScreen() {
  ...
  const levels = [
    { number: 1, exercises: 6, difficulty: 3 },
    { number: 2, exercises: 7, difficulty: 3 },
    { number: 3, exercises: 7, difficulty: 3 },
    { number: 4, exercises: 9, difficulty: 4 },
  ];
...
const cofreImage = `/src/assets/game/cofres/cofre${cofreLevel}.png`;
  ...
  return (
    <div
      ...
      style={{ backgroundImage: "url('/src/assets/game/icons-jungla/jungle.jpg')" }}
    >
...
>
  ...
  />
  <span className="text-yellow-300 font-bold mt-2 text-xl tracking-wide drop-shadow-sm">
   Nivel {level.number}
  </span>
