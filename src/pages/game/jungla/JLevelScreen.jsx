...
export default function LevelScreen() {
  ...
  // MemoRizar ejercicios para evitar referencia cambiante
  ...
  // No mostrar para estos tipos de ejercicio
  const noButtonTypes = ["image", "memory", "dual"];
  return !noButtonTypes.includes(currentExercise.type);
};
    ...
    >
      ...
      <div className="pt-24 min-h-screen flex flex-col items-center justify-center pb-6 px-6">
        <div className="relative w-full max-w-3xl bg-white bg-opacity-80 rounded-xl shadow-xl p-6">
          ...
          {currentExercise?.type === "singleImage" && (
        ...
        {lives === 0 && (
          <LoseOverlay onRetry={restartLevel} onExit={() => navigate("/jungla")} />
        )}
