...
const IMG_PATHS = {
  flags: {
    activo: "/src/assets/game/icons-castillo/escudo1.png",
    desactivo: "/src/assets/game/icons-castillo/escudo2.png",
    bloqueado: "/src/assets/game/icons-castillo/escudo3.png",
  },
  ...
  background: "/src/assets/game/icons-castillo/CastleWorld.jpg",
};
...
export default function CastlePage() {
  ...
  const handleLevelClick = (level) => {
    navigate(`/level/castillo/${level.id}`);
  };
