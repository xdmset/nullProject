...
const MUNDO_ID = 4; // El ID para el mundo "Castillo" en tu base de datos
...
export default function CastlePage() {
    ...
    const getFlagImage = (levelOrder) => {
        if (levelOrder <= nivelesCompletados) return "/src/assets/game/icons-castillo/escudo1.png";
        if (isUnlocked(levelOrder)) return "/src/assets/game/icons-castillo/escudo2.png";
    ...
    return (
        <div
            ...
            style={{ backgroundImage: "url('/src/assets/game/icons-castillo/CastleWorld.jpg')" }}
        >
