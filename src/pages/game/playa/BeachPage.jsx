...
const MUNDO_ID = 1; // ID para el mundo Playa

// Rutas de imágenes
const IMG_PATHS = {
  flags: {
    activo: "/src/assets/game/icons-playa/activo.png",
    desactivo: "/src/assets/game/icons-playa/desactivo.png",
    bloqueado: "/src/assets/game/icons-playa/bloqueado.png",
  },
  ...
  background: "/src/assets/game/icons-playa/playa.png",
};
...
export default function BeachPage() {
  ...
  const renderStars = (levelNumber) => {
    const starsKey = `levelStars-playa`;
    ...
    >
      ...
      <div className="absolute bottom-10 w-full flex gap-32 flex-wrap justify-center items-end">
        {levels.map((level, index) => {
          ...
          const transformStyles = ["-10px", "-40px", "-40px", "-10px"];
          const transformStyle =
            index < 4 ? `translateY(${transformStyles[index]})` : "";
